...
#reshaping
train_in=train_in.reshape(train_in.shape[0],sub_seq,sub_step,n_features)
train_out=train_out.reshape(train_out.shape[0],train_out.shape[1],1)

#print(train_in.shape)

#getting the seq
validation_in,validation_out = data_splitter(n_training,n_validation+n_training-24*30*3,data,in_step,out_step,step)

#reshaping
validation_in = validation_in.reshape(validation_in.shape[0],sub_seq,sub_step,n_features)
...
test_in=test_in.reshape(test_in.shape[0],sub_seq,sub_step,n_features)
